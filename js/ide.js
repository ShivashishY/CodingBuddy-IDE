...
var req = unirest("GET", "https://judge0.p.rapidapi.com/config_info");

req.headers({
	"x-rapidapi-host": "judge0.p.rapidapi.com",
	"x-rapidapi-key": "110c8930e3msh4998e4f12fc8553p11c60djsn47111c758cf5",
	"useQueryString": true
});
...
$(document).ready(function () {
    ...
    console.log("Hey, IDE is open-sourced: https://github.com/ShivashishY/CodingBuddy-IDE. Have fun!");
...
section	.rodata\n\
\n\
msg	db 'hello, CodingBuddy', 0xa\n\
len	equ	$ - msg\n\
";

var bashSource = "echo \"hello, CodingBuddy\"";

var basicSource = "PRINT \"hello, CodingBuddy\"";

var cSource = "\
#include <stdio.h>\n\
\n\
int main(void) {\n\
    printf(\"hello, CodingBuddy\\n\");\n\
    return 0;\n\
}\n\
";
...
public class Hello {\n\
    public static void Main() {\n\
        System.Console.WriteLine(\"hello, CodingBuddy\");\n\
    }\n\
}\n\
";
...
\n\
int main() {\n\
    std::cout << \"hello, CodingBuddy\" << std::endl;\n\
    return 0;\n\
}\n\
";

var clojureSource = "(println \"hello, CodingBuddy\")\n";

var cobolSource = "\
IDENTIFICATION DIVISION.\n\
PROGRAM-ID. MAIN.\n\
PROCEDURE DIVISION.\n\
DISPLAY \"hello, CodingBuddy\".\n\
STOP RUN.\n\
";

var lispSource = "(write-line \"hello, CodingBuddy\")";
...
void main()\n\
{\n\
    writeln(\"hello, CodingBuddy\");\n\
}\n\
";

var elixirSource = "IO.puts \"hello, CodingBuddy\"";

var erlangSource = "\
main(_) ->\n\
    io:fwrite(\"hello, CodingBuddy\\n\").\n\
";

var executableSource = "\
IDE assumes that content of executable is Base64 encoded.\n\
\n\
This means that you should Base64 encode content of your binary,\n\
paste it here and click \"Run\".\n\
\n\";

var fsharpSource = "printfn \"hello, CodingBuddy\"\n";

var fortranSource = "\
program main\n\
    print *, \"hello, CodingBuddy\"\n\
end\n\
";
...
\n\
func main() {\n\
    fmt.Println(\"hello, CodingBuddy\")\n\
}\n\
";

var groovySource = "println \"hello, CodingBuddy\"\n";

var haskellSource = "main = putStrLn \"hello, CodingBuddy\"";

var javaSource = "\
public class Main {\n\
    public static void main(String[] args) {\n\
        System.out.println(\"hello, CodingBuddy\");\n\
    }\n\
}\n\
";

var javaScriptSource = "console.log(\"hello, CodingBuddy\");";

var kotlinSource = "\
fun main() {\n\
    println(\"hello, CodingBuddy\")\n\
}\n\
";

var luaSource = "print(\"hello, CodingBuddy\")";
...
var ocamlSource = "print_endline \"hello, CodingBuddy\"";

var octaveSource = "printf(\"hello, CodingBuddy\\n\");";
...
var plainTextSource = "hello, CodingBuddy\n";

var prologSource = "\
:- initialization(main).\n\
main :- write('hello, CodingBuddy\\n').\n\
";

var pythonSource = "print(\"hello, CodingBuddy\")";

var rSource = "cat(\"hello, CodingBuddy\\n\")";

var rubySource = "puts \"hello, CodingBuddy\"";
...
-- For more information about how to use SQL with API please\n\
...
var typescriptSource = "console.log(\"hello, CodingBuddy\");";

var vbSource = "\
Public Module Program\n\
   Public Sub Main()\n\
      Console.WriteLine(\"hello, CodingBuddy\")\n\
   End Sub\n\
End Module\n\
";
...
{\n\
    MPI_Init(NULL, NULL);\n\
\n\
    int CodingBuddy_size;\n\
    MPI_Comm_size(MPI_COMM_CodingBuddy, &CodingBuddy_size);\n\
\n\
    int CodingBuddy_rank;\n\
    MPI_Comm_rank(MPI_COMM_CodingBuddy, &CodingBuddy_rank);\n\
\n\
    printf(\"Hello from processor with rank %d out of %d processors.\\n\", CodingBuddy_rank, CodingBuddy_size);\n\
\n\
    MPI_Finalize();\n\
\n\
    return 0;\n\
...
\n\
    std::cout << \"Hello from processor with rank \"\n\
              << CodingBuddy_rank << \" out of \" << CodingBuddy_size << \" processors.\\n\";\n\
\n\
    MPI_Finalize();\n\
\n\
    return 0;\n\
...
\n\
comm = MPI.COMM_CodingBuddy\n\
CodingBuddy_size = comm.Get_size()\n\
CodingBuddy_rank = comm.Get_rank()\n\
\n\
print(f\"Hello from processor with rank {CodingBuddy_rank} out of {CodingBuddy_size} processors\")\n\
";

var nimSource = "\
# On the IDE, Nim is automatically\n\
# updated every day to the latest stable version.\n\
echo \"hello, CodingBuddy\"\n\
";
